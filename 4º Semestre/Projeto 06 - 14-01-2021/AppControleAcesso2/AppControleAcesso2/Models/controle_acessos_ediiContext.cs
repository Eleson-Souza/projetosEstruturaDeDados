...
{
    public partial class controle_acessos_ediiContext : DbContext
    {
        public controle_acessos_ediiContext()
        {
        }

        public controle_acessos_ediiContext(DbContextOptions<controle_acessos_ediiContext> options)
            : base(options)
        {
        }
